  ...
  <body>
    ...
    <div class="container">
      ...
      <div style="background-color:grey;" class="jumbotron text-center">
        ...
        <hr class="my-4">
        <a class="btn btn-Dark btn-sm" style="color:white">LinkedIn Profile : </a>
        <a class="btn btn-Dark btn-sm" href="https://www.linkedin.com/in/kimberly-kang-35450b75?trk=profile-badge" style="color:white">Kimberly Kang</a>
        <a class="btn btn-Dark btn-sm" href="https://www.linkedin.com/in/phoebemiao/" style="color:white">Phoebe Miao</a>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="page-header">
            <h2 style="color:white;font-weight:bold; text-align: center">Our Gas Price Analysis</h2>
          </div>

           

          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">Original Factors from the Data Research</h3>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">More Interesting Factors </h3>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">More Factors from Consumer Data</h3>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">[Multiple Regression Model 1 (MRM 1)]</h3>
            <ul>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">[Multiple Regression Model 2 (MRM 2)]</h3>
            <ul>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">[Multiple Regression Model 3 (MRM 3)]</h3>
            <ul>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">[Multiple Regression Model 4 (MRM 4)]</h3>
            <ul>
          ...
          <div class="col-md-12">
            <h3 style="font-size:130%; color:white; text-align: center; font-weight:bold">Measure Metrics with our 4 models</h3>
      ...
      <div class="row">
        ...
        <!-- <div class="row">
          ...
          <div class="col-md-6">
            ...
            <img src="https://raw.githubusercontent.com/FIRE-Phoebe/Gas_Price_analysis/main/Web%20Scraping/images/import_export_graph.png" class = "center" style="width:550px;height:450px;">
          </div>
            <!-- <div class="thumbnail"> -->
          <div class="col-md-6">
            <div class="col-md-12">
              <h3 style="font-size:120%; color:white; text-align: center;font-weight:bold">Stock Market to GDP(%)</h3>
              <img src="https://raw.githubusercontent.com/FIRE-Phoebe/Gas_Price_analysis/main/Web%20Scraping/images/stock_market_to_GDP(%25).png" class="center" style="width:550px;height:450px;">
            </div>
          </div>

          <div class="col-md-6">
            <h3 style="font-size:120%; color:white; text-align: center; font-weight:bold">Inflation(%)</h3>
            <img src="https://raw.githubusercontent.com/FIRE-Phoebe/Gas_Price_analysis/main/Web%20Scraping/images/inflation.png" class = "center" style="width:550px;height:450px;">
          </div>
            <!-- <div class="thumbnail"> -->
          <div class="col-md-6">
            <div class="col-md-12">
              <h3 style="font-size:120%; color:white; text-align: center;font-weight:bold">Interest Rate(%)</h3>
              <img src="https://raw.githubusercontent.com/FIRE-Phoebe/Gas_Price_analysis/main/Web%20Scraping/images/interest_rate(%25).png" class="center" style="width:550px;height:450px;">
            </div>
          </div>
          <div class="col-md-12">
